...
# One-stage fixed-layer KL precision-at-K hinge objective weights.
RANK_LOSS_WEIGHT=${RANK_LOSS_WEIGHT:-0.5}
KL_LOSS_WEIGHT=${KL_LOSS_WEIGHT:-6.0}
...
RUN_NAME=${RUN_NAME:-"official_llava_learnable_prune_lightweight_top64_layer18_sample0.2"}
...
PREDICTOR_RANK=${PREDICTOR_RANK:-128}
